...
Estoque voltar;
   ...
   atualizarQntd();
    ...
    private void initComponents() {
        ...
        setTitle(" Carlos Pizza - Solicitar Produto");
        ...
        txtQntd.setFont(new java.awt.Font("Lucida Sans", 0, 14)); // NOI18N
        ...
        dataTxt.setFont(new java.awt.Font("Lucida Sans", 0, 14)); // NOI18N
        ...
        txtQntdA.setFont(new java.awt.Font("Lucida Sans", 0, 14)); // NOI18N
    ...
    private void confirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_confirmarActionPerformed
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Produtos solicitados com sucesso!!!","Mensagem do Programa",JOptionPane.INFORMATION_MESSAGE);
            con_cliente.executaSQL("select * from produto order by id_Produto");
