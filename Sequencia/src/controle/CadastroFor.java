...
conexao con_cliente;
    ...
    public CadastroFor() {
       ...
       String email = txtFor.getText();
       String nome = txtNomefo.getText();
       String tele = txtTelFor.getTxet();
        try {
            String insert_sql="insert into `fornecedor`(`email`,`nomeE`,`tel`) values ('" + email + "','" + nome + "','" + tele + "')";
