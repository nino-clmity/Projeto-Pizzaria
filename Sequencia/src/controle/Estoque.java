        ...
        try {
            ...
            while(con_cliente.resultset.next()){
                modelo.addRow(new Object[]{
                    con_cliente.resultset.getString("id_Produto"),con_cliente.resultset.getString("nome_Produto"),con_cliente.resultset.getString("categoria"),con_cliente.resultset.getString("quantidade"), con_cliente.resultset.getString("validade"), con_cliente.resultset.getString("data_Acesso")});
            }
